...
class DataTests(unittest.TestCase):
    ...
    FIELD_TBL_ENCODED = ('\x00\x00\x00\xce'
            '\x07longvall\x00\x00\x00\x006e&U'
            '\x06intvalI\x00\x00\x00\x01'
            '\x07dictvalF\x00\x00\x00\x0c\x03fooS\x00\x00\x00\x03bar'
            '\x07unicodeS\x00\x00\x00\x08utf8=\xe2\x9c\x93'
            '\x05arrayA\x00\x00\x00\x0fI\x00\x00\x00\x01I\x00\x00\x00\x02I\x00\x00\x00\x03'
            '\x04nullV'
            '\x06''strvalS\x00\x00\x00\x04Test'
            '\x0ctimestampvalT\x00\x00\x00\x00Ec)\x92'
            '\x07decimalD\x02\x00\x00\x01:'
            '\x07boolvalt\x01'
            '\x0bdecimal_tooD\x00\x00\x00\x00d'
            '\x06binvalx\x00\x00\x00\x07bindata')

    FIELD_TBL_VALUE = {'array': [1, 2, 3],
                       'binval': data.binary('bindata'),
                       'boolval': True,
